...
const (
	GoService_SendTrainingData_FullMethodName = "/model.GoService/SendTrainingData"
)
...
type GoServiceClient interface {
	SendTrainingData(ctx context.Context, in *TrainingRequest, opts ...grpc.CallOption) (*TrainingResponse, error)
}
...
func (c *goServiceClient) SendTrainingData(ctx context.Context, in *TrainingRequest, opts ...grpc.CallOption) (*TrainingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TrainingResponse)
	err := c.cc.Invoke(ctx, GoService_SendTrainingData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GoServiceServer interface {
	SendTrainingData(context.Context, *TrainingRequest) (*TrainingResponse, error)
...
func (UnimplementedGoServiceServer) SendTrainingData(context.Context, *TrainingRequest) (*TrainingResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendTrainingData not implemented")
}
...
func _GoService_SendTrainingData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TrainingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GoServiceServer).SendTrainingData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GoService_SendTrainingData_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoServiceServer).SendTrainingData(ctx, req.(*TrainingRequest))
	}
...
var GoService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "model.GoService",
	HandlerType: (*GoServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SendTrainingData",
			Handler:    _GoService_SendTrainingData_Handler,
		},
	},
